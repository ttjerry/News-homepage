  ...
  return (
    <div className="flex lg:flex-row lg:px-24 flex-col gap-8 px-5">
      <div className="flex flex-col lg:w-8/12 gap-2">
        <img src="/assets/images/image-web-3-mobile.jpg" className="lg:hidden flex" alt="" />
        <img src="/assets/images/image-web-3-desktop.jpg" alt="" className="hidden lg:flex lg:h-4/6"  />
        <span className="flex flex-col gap-8 lg:pt-8 lg:gap-16 lg:h-2/6 h-4/6 lg:flex-row lg:justify-around items-start">
          <h1 className="font-bold lg:text-4xl text-4xl">The Bright Future of Web 3.0</h1>
...
function Footer() {
  return(
    ...
    {footer.map(({cardImage,number,text1,details})=>(
      <div className="flex flex-row gap-4 py-3 px-5">
